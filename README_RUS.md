...
1. [Logical view of database model](#logical-view-of-database-model)
2. [Part 1. Создание базы данных](#part-1-создание-базы-данных)  
3. [Part 2. Изменение данных](#part-2-изменение-данных)  
4. [Part 3. Получение данных](#part-3-получение-данных)  
5. [Дополнительно. Part 4. Метаданные](#дополнительно-part-4-метаданные)


В данном проекте создается база данных Школы 21, а также процедуры и функции для получения информации и также процедуры и триггеры для её изменения.
